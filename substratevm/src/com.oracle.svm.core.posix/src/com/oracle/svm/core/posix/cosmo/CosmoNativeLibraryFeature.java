...
class CosmoNativeLibraryFeature implements InternalFeature {
    ...
    public void afterRegistration(AfterRegistrationAccess access) {
        ...
        if(x.getAsBoolean()) {
            CosmoNativeLibrarySupport.initialize();
        }
    }
...
final class CosmoNativeLibrarySupport extends JNIPlatformNativeLibrarySupport {
    ...
    static void initialize() {
        ImageSingletons.add(PlatformNativeLibrarySupport.class, new CosmoNativeLibrarySupport());
    }
    ...
    @Override
    public CosmoNativeLibrary createLibrary(String canonical, boolean builtIn) {
        return new CosmoNativeLibrary(canonical, builtIn);
    }
    ...
    class CosmoNativeLibrary implements NativeLibrary {
        ...
        CosmoNativeLibrary(String canonicalIdentifier, boolean builtin) {
        ...
        public boolean unload() {
            ...
            if (CosmoUtils.dlclose(dlhandle)) {
        ...
        private boolean doLoad() {
            ...
            dlhandle = CosmoUtils.dlopen(canonicalIdentifier, Dlfcn.RTLD_LAZY());
        ...
        public PointerBase findSymbol(String name) {
            ...
            assert dlhandle.isNonNull();
            return CosmoUtils.dlsym(dlhandle, name);
        }
    }
}
