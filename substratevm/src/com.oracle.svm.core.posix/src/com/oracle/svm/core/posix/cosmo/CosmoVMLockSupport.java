...
import com.oracle.svm.core.posix.cosmo.headers.Semaphore;
...
@AutomaticallyRegisteredImageSingleton(value = VMLockSupport.class, onlyWith = CosmoLibCSupplier.class)
